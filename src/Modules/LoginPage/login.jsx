...
const login = () => {
  return (
    <>
      <div className="loginbg relative bg-opacity-30 bg-black">
        ...
        <div className="flex justify-center lg:flex lg:justify-end  lg:mx-[10%]">
          <div className="w-full mx-5 lg:w-[40%] max-w-[700px] px-10 py-20 rounded-3xl border-2 bg-white border-gray-100  my-8 ">
            ...
            <div className="text-5xl flex justify-center items bg-gray-500 "></div>
            ...
            <div className="text=5xl bg-gray-599 flex justify-self-end items-center"></div>
